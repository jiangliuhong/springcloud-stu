 ...
 */
@Slf4j
@ConditionalOnProperty(name = "scs.audit-log.log-type", havingValue = "db")
...
public class DbAuditServiceImpl implements IAuditService {
    ...
    public void save(Audit audit) {
        this.jdbcTemplate.update(INSERT_SQL, audit.getApplicationName(), audit.getClassName(), audit.getMethodName(),
            audit.getUserId(), audit.getUserName(), audit.getClientId(), audit.getOperation(), audit.getTimestamp());
    }
}
